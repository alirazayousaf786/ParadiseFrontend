      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            Fresh & beautiful flowers delivered with love.  
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li><Link className="hover:text-rose-600 transition" to="/">Home</Link></li>
            <li><Link className="hover:text-rose-600 transition" to="/about">About</Link></li>
            <li><Link className="hover:text-rose-600 transition" to="/product">Shop</Link></li>
            <li><Link className="hover:text-rose-600 transition" to="/service">Services</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li className="hover:text-rose-600 cursor-pointer transition">FAQs</li>
            <li className="hover:text-rose-600 cursor-pointer transition">Privacy Policy</li>
            <li className="hover:text-rose-600 cursor-pointer transition">Terms & Conditions</li>
            <li className="hover:text-rose-600 cursor-pointer transition">Refund Policy</li>
          </ul>
        </div>
